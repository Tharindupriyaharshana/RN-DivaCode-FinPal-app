...
export default class Home extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <
            Text style = {
                { fontSize: 20, color: "#f8c291" } } > Aswanu < /Text> <
            /Body> <
            Right >
            ...
            <
            Dialog visible = { this.state.promptVisible }
            // title={"  "}
            onTouchOutside = {
                () => this.setState({
                    promptVisible: false,
            ...
            <
            View style = {
                { backgroundColor: "#6a89cc", flex: 30, height: 10 } } >
            ...
            renderItem = {
                ({ item }) => < Card style = {
                    { backgroundColor: "#0c2461", borderRadius: 20 } }
                ...
                /Text> <
                Text style = {
                    { color: "#0c2461", marginLeft: "70%", fontSize: 16 } } > More details < /Text> <
                Text style = {
                    { color: "#e55039" } } > Author: { item.name } < /Text> <
                Text style = {
                    { color: "#e55039" } } > Date: { item.showTime } < /Text> <
                /TouchableOpacity>
